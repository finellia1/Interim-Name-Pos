...
<div id="calblock"><form id="calform">
  ...
  <input type="hidden" id="event_order_ID" name="event_order_ID"/>
  <label for="start">Date Start</label>
  <input type="datetime-local" id="event_start" name="start" required/>
  <label for="end">Date End</label>
  <input type="datetime-local" id="event_end" name="end" required/>
