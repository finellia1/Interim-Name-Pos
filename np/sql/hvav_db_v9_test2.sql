...
--
CREATE DATABASE IF NOT EXISTS `hvav_db_v9_test` DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci;
USE `hvav_db_v9_test`;
...
INSERT INTO `employee` (`employee_ID`, `security_type`, `pwd`, `job_title`, `first_name`, `last_name`, `email`, `yearly_salary`, `is_inactive`) VALUES
(1, 'administrator', 'testpassword1', 'Systems Adminis', 'Sarah', 'Jones', 'sjones@email.com', '0.00', 0),
(2, 'manager', 'testpassword2', 'Manager', 'John', 'Smith', 'jsmith@email.com',  '0.00', 0),
(3, 'staff', 'testpassword3', 'Technician', 'Amy', 'Baker', 'abaker@email.com', '0.00', 0),
(4, 'staff', 'testpassword4', 'Warehouse', 'Dan', 'Arnold', 'darnold@email.com', '0.00', 0),
(5, 'user', 'testpassword5', 'Warehouse Trainee', 'Bill', 'Miller', 'bmiller@email.com', '0.00', 0);
...
CREATE TABLE `authorize_credentials` ( 
    ...
    PRIMARY KEY (`authorize_credentials_ID`)) 
    ENGINE = InnoDB;
