...
--
-- Host: 127.0.0.1
-- Generation Time: May 05, 2022 at 10:09 AM
...
(47, 'Party', 0, '2022-05-05', '2022-05-05 09:25:23', '2022-05-05 09:25:23', 1, 1, '2022-05-05 09:25:23', '2022-05-05 09:25:23', '2022-05-05 09:25:23', 0, 0, 0, 0, 'S. Jones', '', '100', '', '');

-- --------------------------------------------------------

--
-- Table structure for table `event_order_list`
--

CREATE TABLE `event_order_list` (
  `event_order_list_ID` int(11) NOT NULL,
...
--
-- Dumping data for table `event_order_list`
--

INSERT INTO `event_order_list` (`event_order_list_ID`, `product_ID_fk`, `event_order_ID_fk`, `quantity`) VALUES
(2, 13, 47, 2),
(1, 31, 46, 2),
(1, 33, 46, 3);
...
--
-- Indexes for table `event_order_list`
--
ALTER TABLE `event_order_list`
  ADD PRIMARY KEY (`product_ID_fk`,`event_order_ID_fk`);
...
--
ALTER TABLE `event_order`
  MODIFY `event_order_ID` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=48;
