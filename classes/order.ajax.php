...
switch ($_POST["req"]) {
  ...
  case "save":
    ...
    echo $_CAL->save(
      $_POST["event_type"], $_POST["is_nonprofit"], $_POST["order_date"], $_POST["event_start"], $_POST["event_end"], $_POST["setup_start"], $_POST["breakdown_start"], $_POST["is_staffed"], $_POST["created_by"], $_POST["event_name"], $_POST["expected_num_people"], $_POST["contact_option"], $_POST["event_notes"],
