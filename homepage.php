            ...
            <div class = "left-panel">
                <div class = "nav-bar">
                    <ul>
                        ...
                        <li>
                            <a class = "calendar" href="calendarpage.html">
                        ...
                        <li>
                            <a class = "money" href="moneypage.html">
                        ...
                        <li>
                            <a class = "history" href="historypage.html">
                        ...
                        <li>
                            <a class = "settings" href="link to settings tab">
...
<?php 
require '../test/classes/session.classes.php';
...
<head>
    <link rel="stylesheet" href="../test/css/inventoryStyle.css">
</head>
...
<body>
    ...
    <div id="addPopup" class = "popup">
        <form name="add" action="../test/includes/addProduct.inc.php" method="post">
            <table class="dropShadow">
                    <td class="alignLeft">
                        <label for="itemName">Item Name:</label></td>
                    <td class="alignLeft">
    ...
    <script type="text/javascript" src="../test/js/inventory.js"></script>
