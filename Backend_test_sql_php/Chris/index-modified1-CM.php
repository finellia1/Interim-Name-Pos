<<<<<<< Updated upstream:Backend_test_sql_php/Chris/index-modified1-CM.php
<?php 
...
=======
                    <?php
                        echo "<h4 style = 'color: red;'>{$_SESSION["addUserErrorMsg"]}</h4>"
                    ?>
>>>>>>> Stashed changes:header.php
            ...
            <div>
                <h4>Remove User</h4>
                <?php
                    echo "<h4 style = 'color: red;'>{$_SESSION["removeUserErrorMsg"]}</h4>"
                ?>
            ...
            <div>
                ...
                <?php
                    echo "<h4 style = 'color: red;'>{$_SESSION["updateProductErrorMsg"]}</h4>"
                ?>
